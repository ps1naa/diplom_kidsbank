...
Проект распространяется на условиях **проприетарной лицензии** (файл [`LICENSE`](LICENSE) в корне репозитория). Это **не** открытая лицензия MIT: третьим лицам без письменного разрешения правообладателя запрещены коммерческое использование, копирование и создание производных работ. Подробности — в тексте `LICENSE`.
