...
{
    /// <inheritdoc />
    public partial class AddFamilySubscriptions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    subscribed_by_user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    plan = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    price_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    currency = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: "BYN"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_family_subscriptions_users_subscribed_by_user_id",
                        column: x => x.subscribed_by_user_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_family_subscriptions_family_active",
                table: "family_subscriptions",
                columns: new[] { "family_id", "is_active" });

            migrationBuilder.CreateIndex(
                name: "ix_family_subscriptions_family_id",
                table: "family_subscriptions",
                column: "family_id");

            migrationBuilder.CreateIndex(
                name: "IX_family_subscriptions_subscribed_by_user_id",
                table: "family_subscriptions",
                column: "subscribed_by_user_id");
        }
