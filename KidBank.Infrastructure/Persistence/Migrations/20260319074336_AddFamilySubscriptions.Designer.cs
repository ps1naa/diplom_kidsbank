...
namespace KidBank.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260319074336_AddFamilySubscriptions")]
    partial class AddFamilySubscriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KidBank.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("KidBank.Domain.Entities.ClientSetting", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("KidBank.Domain.Entities.EducationMission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrderIndex")
                        .HasDatabaseName("ix_education_missions_order");

                    b.ToTable("education_missions", (string)null);
                });
            ...
            modelBuilder.Entity("KidBank.Domain.Entities.FamilySubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("SubscribedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("subscribed_by_user_id");
                    ...
                    b.ToTable("family_subscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("KidBank.Domain.Entities.TaskTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_task_templates_parent_id");
            ...
            modelBuilder.Entity("KidBank.Domain.Entities.EducationModule", b =>
                {
                    b.HasOne("KidBank.Domain.Entities.EducationMission", "Mission")
                        .WithMany("Modules")
            ...
            modelBuilder.Entity("KidBank.Domain.Entities.FamilySubscription", b =>
                {
                    ...
                    b.HasOne("KidBank.Domain.Entities.User", "SubscribedByUser")
                        .WithMany()
